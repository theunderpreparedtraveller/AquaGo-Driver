...
export default function InsuranceScreen() {
  ...
  const [verificationStatus, setVerificationStatus] = useState<'verified' | 'pending' | 'rejected' | 'not uploaded'>('not uploaded');
  ...
  const getStatus = async () => {
    ...
    .select('*')
    .eq('id', userid);
    setVerificationStatus(data[0].insurance_status);
  }
  useEffect(() => {
    getStatus();
  }, []);
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusHeader}>
            ...
            <View style={styles.statusInfo}>
              <Text style={styles.statusTitle}>Vehicle Insurance</Text>
          ...
          {verificationStatus === 'verified' && (
            <Text style={styles.statusDescription}>
              Your vehicle insurance has been verified and approved.
            </Text>
          )}
          ...
          {verificationStatus === 'rejected' && (
            <Text style={styles.statusDescription}>
              Your document was rejected. Please upload a clear, valid insurance certificate.
            </Text>
          )}
        ...
        <View style={styles.uploadSection}>
          ...
          {uploadedImage ? (
            ...
            >
              ...
              <Text style={styles.uploadTitle}>Upload Insurance Certificate</Text>
        ...
        <View style={styles.noteSection}>
          ...
          <Text style={styles.noteText}>
            Your vehicle insurance must be valid and cover commercial use for water delivery services. 
            Expired or invalid insurance will result in account suspension.
          </Text>
        </View>
